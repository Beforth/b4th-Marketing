...
urlpatterns = [
    ...
    path('visits/<int:visit_id>/complete/', views.visit_complete, name='visit_complete'),
    path('visits/<int:visit_id>/reschedule/', views.visit_reschedule, name='visit_reschedule'),
    ...
    path('follow-ups/mark-all-complete/', views.mark_all_followups_complete, name='mark_all_followups_complete'),
    ...
    path('urs/<int:urs_id>/approve/', views.urs_approve, name='urs_approve'),
    path('urs/<int:urs_id>/reject/', views.urs_reject, name='urs_reject'),
    ...
    path('system/users/<int:user_id>/delete/', views.user_delete, name='user_delete'),
    path('system/users/<int:user_id>/toggle-status/', views.user_toggle_status, name='user_toggle_status'),
